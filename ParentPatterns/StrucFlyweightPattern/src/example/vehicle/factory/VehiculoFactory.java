...
public class VehiculoFactory {
	// El pool se encargará de almacenar las instancias de los objetos
	// reutilizables
	...
	public static ModeloVehiculo GetCar(String marca, String modelo, String color) {
		...
		// En caso de que no exista, se instancia un nuevo objeto y se añade al
		// pool.
		// Las próximas ocasiones en las que el objeto sea utilizado, se
		// devolverá una referencia
		// al objeto existente, evitando ocupar más memoria en crear una nueva
		// instancia
		else {
			// Dependiendo de algún parámetro (por ejemplo, si el modelo tiene
			// el sufijo 'sport'), se
			...
			// Se añade el objeto al pool: las sucesivas llamadas usarán este
			// objeto en lugar de
